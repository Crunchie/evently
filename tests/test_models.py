...
def test_expected_headcount():
    ...
    InvitationAttendee.objects.create(invitation=inv1, contact=c1, rsvp_status=Rsvp.GOING)
    ...
    InvitationAttendee.objects.create(invitation=inv2, contact=c2, rsvp_status=Rsvp.GOING)
    InvitationAttendee.objects.create(invitation=inv2, contact=c3, rsvp_status=Rsvp.GOING)
    InvitationAttendee.objects.create(invitation=inv2, contact=c4, rsvp_status=Rsvp.CANT)
    ...
    InvitationAttendee.objects.create(invitation=inv3, contact=c5, rsvp_status=Rsvp.MAYBE)
